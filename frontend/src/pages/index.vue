  ...
  <div class="container mx-auto px-4 py-12 max-w-7xl bg-slate-50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
      ...
      <div class="bento-card bg-white p-8 shadow-md md:col-span-2 md:row-span-2">
        <h2 class="text-2xl font-semibold mb-4 text-c">多智能体协作的革命性突破</h2>
        <div class="space-y-6">
      ...
      <div class="bento-card bg-white p-6 shadow-md">
        <div class="flex items-center mb-4">
          <Cpu class="w-6 h-6 text-brand-start mr-2" />
      ...
      <div class="bento-card bg-white p-6 shadow-md">
        <div class="flex items-center mb-4">
          <CheckCircle class="w-6 h-6 text-brand-start mr-2" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
      ...
      <div class="bento-card bg-white p-6 shadow-md">
        <div class="flex items-center mb-4">
          <BarChart2 class="w-6 h-6 text-brand-start mr-2" />
        ...
        <div class="space-y-4">
          ...
          <div>
            <div class="flex justify-between mb-1">
              <span class="text-sm font-medium">Colony AI</span>
      ...
      <!-- CTA卡片 -->
      <div class="bento-card gradient-bg-alt p-6 shadow-md text-white">
        <h2 class="text-xl font-semibold mb-4">立即开启您的智衍之旅</h2>
        <p class="text-gray-100 mb-6">体验革命性的多智能体协作平台，节省时间，提高效率</p>
        <button class="w-full py-3 px-6 rounded-lg bg-white/20 font-medium hover:bg-white/30 transition-colors"
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <p class="text-sm text-gray-600">
            我们致力于通过多智能体协作技术简化数学建模等复杂工作流程，为学生和研究人员提供高效的解决方案。
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a :href=QQ_GROUP target="_blank" class="text-gray-400 hover:text-brand-end">
            ...
            <a :href=GITHUB_LINK class="text-gray-400 hover:text-brand-end">
              <Github class="w-5 h-5" />
            </a>
            <a :href=TWITTER class="text-gray-400 hover:text-brand-end">
